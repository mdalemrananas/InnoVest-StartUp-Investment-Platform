...
<body>
    ...
    <section class="page-header bg_img" data-background="assets/images/banner/signin-header.png">
        <div class="container">
            <div class="page-header-content">
                <h1 class="title">Our Login Page</h1>
                <ul class="breadcrumb">
                    <li>
                        <a href="home.php">Home</a>
                    </li>
    ...
    <div class="login-section padding-top padding-bottom">
        <div class="container">
            ...
            <p class="text-center">Login with your email and password.</p>
                <form class="account-form" action="login-user.php" method="post" enctype="multipart/form-data" id="myform" autocomplete="on">
                ...
                <?php
                    ...
                    <div class="form-group">
                        <button class="d-block custom-button" type="submit" name="login" value="Login"><span>Sign In</span></button>
                    </div>
                </form>
                <div class="account-bottom">
                    <span class="d-block cate pt-10">Don’t Have any Account?  <a href="signup-user.php">Sign Up</a></span>
                    <!--<span class="or"><span>or</span></span>
                    <h5 class="subtitle">Signin With Google</h5>
