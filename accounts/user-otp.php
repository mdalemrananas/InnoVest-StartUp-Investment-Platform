    ...
    <div class="login-section padding-top padding-bottom">
        <div class="container">
            <div class="account-wrapper">
                ...
                <form class="account-form" action="user-otp.php" method="post" enctype="multipart/form-data" id="myform" autocomplete="off">
                    ...
                    <div class="form-group">
                        <input type="number" name="otp" id="otp" placeholder="Enter verification code" required>
                    </div>
                    <div class="form-group">
                        <button class="d-block custom-button"  type="submit" name="check" value="Submit"><span>Verification</span></button>
                    </div>
                </form>
