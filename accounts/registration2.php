...
$ran_id = isset($_SESSION["ran_id"]) ? $_SESSION["ran_id"] : '';
?>
                                ...
                                <ul class="submenu">
                                    ...
                                    <li>
                                        ...
                                        <ul class="submenu">
                                            ...
                                            <li><a href="registration.html" class="active">Sign Up</a></li>
                                        </ul>
                                    </li>
                                    <li>
                                        <a href="#0">Events</a>
    ...
    <section class="page-header bg_img" data-background="assets/images/banner/signup-header.png">
        <div class="container">
            <div class="page-header-content">
                <h1 class="title">LonelyPro Register Now</h1>
                <ul class="breadcrumb">
                    <li>
    ...
    <div class="login-section padding-top padding-bottom">
        <div class="container">
            <div class="account-wrapper">
                ...
                <form class="account-form" action="verify_code2.php?username=<?php echo urlencode($username);?> &email=<?php echo urlencode($email);?> &password=<?php echo $password;?> &ran_id=<?php echo urlencode($ran_id); ?>" method="post" enctype="multipart/form-data" id="myform" autocomplete="on">
                    
                    <div class="form-group">
                        <input type="number" placeholder="Enter Verification Code" name="verify_code" id="verify_code" required>
                    </div>
                    <div class="form-group">
                        <button class="d-block custom-button" name="send" value="send"><span>Verification</span></button>
                    </div>
                </form>
                            ...
                            <div class="ftt-item">
                                <div class="ftt-inner">
                                    ...
                                    <div class="ftt-content">
                                        <p class="mb-0">Phone Number : +8801 939 702 520</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4 col-sm-6 col-12">
                            <div class="ftt-item">
                                <div class="ftt-inner">
                                    ...
                                    <div class="ftt-content">
                                        <p class="mb-0">Email :yourmail@gmail.com</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4 col-sm-6 col-12">
                            <div class="ftt-item">
                                <div class="ftt-inner">
                                    ...
                                    <div class="ftt-content">
                                        <p class="mb-0">Address : 30 North West New York 240</p>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <div class="footer-bottom">
            <div class="container">
                <div class="text-center">
                    <p class="mb-0">&copy; 2021 <a href="index.html">Lonely Pro</a> - Best For Charity HTML Template.</p>
                </div>
            </div>
        </div>
    </footer>
